...
require('lazy').setup({
  ...
  -- Oil provides a nice file explorer that opens in the current buffer, instead of a new split.
  {
    'stevearc/oil.nvim',
    ---@module 'oil'
    ---@type oil.SetupOpts
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      local ensure_installed = {
        ...
        'basedpyright', -- Python LSP (better uv support than pyright)
        'ruff', -- Python linter/formatter LSP (works great with uv)
        'rust-analyzer', -- Rust LSP (note: hyphen for Mason, underscore for LSP)
