...
function M.setup()
  vim.keymap.set('n', '<leader>cP', function() terminal.toggle() end, { desc = 'OpenCode CLI toggle' })
  ...
  end, { desc = 'OpenCode CLI with range ref' })

  vim.keymap.set('n', '<leader>cp', function() external.open() end, { desc = 'OpenCode CLI in external terminal' })
  ...
  end, { desc = 'OpenCode CLI in external terminal with range ref' })

  vim.keymap.set('n', '<leader>cm', function() commit.generate() end, { desc = 'OpenCode [C]ommit [M]essage to clipboard' })
end
